...
//	printk("%s:called : line :%d val:0x%x\n",hwmon_data->adl_dev->Bmc_Capabilities[0]);
	...
	printk("adl_cap in fan driver: 0x%x\n", hwmon_data->adl_dev->Bmc_Capabilities[0]);
