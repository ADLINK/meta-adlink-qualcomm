...
SRC_URI:append ="file://Makefile \
		 file://main.c \
		 file://storage.c \
		 file://adl-bmc-nvmem.c \
		 file://adl-bmc-hwmon.c \
		 file://adl-bmc-boardinfo.c \
		 file://adl-bmc.c \
		 file://boardinfo.c"
...
do_compile:prepend() {
	...
	rm -r ${WORKDIR}/git/lib/boardinfo.c
	cp ${WORKDIR}/Makefile ${WORKDIR}/git/Makefile
	cp ${WORKDIR}/boardinfo.c ${WORKDIR}/git/lib/boardinfo.c
	cp ${WORKDIR}/storage.c ${WORKDIR}/git/lib/storage.c
	cp ${WORKDIR}/main.c ${WORKDIR}/git/app/main.c
	cp ${WORKDIR}/adl-bmc-nvmem.c ${WORKDIR}/git/driver/adl-bmc-nvmem.c
}
